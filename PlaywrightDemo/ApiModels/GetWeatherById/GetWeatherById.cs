...
namespace PlaywrightDemo.ApiModels.GetWeatherById
{
    internal class GetWeatherById
    {
        private ApiHelper _apiHelper;
        [ThreadStatic]
        private IAPIResponse? _response;

        public GetWeatherById(IPlaywright playwright)
        {
        ...
        public async Task<IAPIResponse> GetWeatherByIdAsync(string? endPoint, Dictionary<string, object> searchParams)
        {
